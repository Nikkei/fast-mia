...
It basically supports the same [GPU requirements as vLLM](https://docs.vllm.ai/en/v0.23.0/getting_started/installation/gpu/).
...
|------------------|-------------------------|------------|------------------------------|--------------|-------------|
| baseline         | LOSS                    | 69.4 / 69.4 | 11s / 57s (×5.18)            | 84.3 / 84.3  | 18.3 / 18.3 |
|                  | PPL/zlib                | 69.8 / 69.8 | 11s / 57s (×5.18)            | 80.2 / 80.2  | 14.5 / 14.5 |
|                  | Ref                     | 62.7 / 63.6 | 16s / 1m35s (×5.94)          | 86.9 / 85.9  | 8.5 / 10.3 |
| token distribution | Min-K% Prob (K=0.1)   | 67.1 / 67.2 | 11s / 57s (×5.18)            | 83.3 / 83.3  | 17.3 / 17.3 |
|                  | Min-K% Prob (K=0.2)     | 69.3 / 69.3 | 11s / 57s (×5.18)            | 82.3 / 82.3  | 22.0 / 22.0 |
|                  | Min-K% Prob (K=0.3)     | 70.1 / 70.1 | 11s / 57s (×5.18)            | 82.3 / 82.3  | 19.4 / 19.6 |
|                  | Min-K% Prob (K=0.5)     | 69.7 / 69.7 | 11s / 57s (×5.18)            | 82.5 / 82.5  | 18.1 / 18.1 |
...
|                  | ReCaLL                  | 91.1 / 90.3 | 56s / 2m10s (×2.32)          | 27.2 / 34.7  | 48.6 / 48.8 |
|                  | Con-ReCall          | 94.8 / 96.1 | 1m46s / 3m30s (×1.98)        | 15.7 / 12.9  | 66.1 / 73.6 |
| black-box        | SaMIA               | 61.1 / 64.5 | 2h10m12s / 40h9m53s (×18.5)   | 93.3 / 90.7  | 13.4 / 15.5 |
