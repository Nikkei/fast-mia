...
It basically supports the same [GPU requirements as vLLM](https://docs.vllm.ai/en/v0.29.0/getting_started/installation/gpu/).
...
|                  | Ref                     | 62.9 / 63.6 | 14s / 1m35s (×6.79)          | 87.4 / 85.9  | 8.3 / 10.3 |
| token distribution | Min-K% Prob (K=0.1)   | 67.1 / 67.2 | 12s / 57s (×4.75)            | 83.3 / 83.3  | 17.3 / 17.3 |
|                  | Min-K% Prob (K=0.2)     | 69.3 / 69.3 | 12s / 57s (×4.75)            | 82.3 / 82.3  | 22.0 / 22.0 |
|                  | Min-K% Prob (K=0.3)     | 70.1 / 70.1 | 12s / 57s (×4.75)            | 82.3 / 82.3  | 19.4 / 19.6 |
...
|                  | AECA                    | 68.9 / 68.9 | 12s / 57s (×4.75)            | 84.3 / 84.3  | 21.4 / 21.7 |
| text alternation | Lowercase               | 64.1 / 64.1 | 24s / 1m59s (×4.96)          | 83.5 / 83.8  | 11.6 / 11.6 |
|                  | Neighbour               | 57.7 / 56.7 | 21m24s / 1h25m55s (×4.01)     | 88.9 / 91.8  | 6.7 / 6.5 |
|                  | PAC                     | 73.4 / 73.4 | 1m13s / 6m24s (×5.26)        | 77.9 / 77.9  | 24.0 / 24.3 |
|                  | ReCaLL                  | 91.1 / 90.3 | 59s / 2m10s (×2.20)          | 27.2 / 34.7  | 48.6 / 48.8 |
|                  | Con-ReCall          | 94.8 / 96.1 | 1m51s / 3m30s (×1.89)        | 15.9 / 12.9  | 66.7 / 73.6 |
| black-box        | SaMIA               | 66.7 / 64.5 | 2h18m56s / 40h9m53s (×17.3)   | 90.5 / 90.7  | 15.2 / 15.5 |
